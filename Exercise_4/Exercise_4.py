...
print("The accuracy for Naive Bayes is: ", round(accuracy_naivebayes, 2)) 
...
print("The accuracy for Bayes is: ", round(accuracy_bayes, 2))
...
image_shapes = ['1x1',' 2x2', '4x4', '8x8', '16x16']
